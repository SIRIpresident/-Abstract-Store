    ...
    <div>
      <Wrapper page={page}>
        ...
        <div className="container">
          ...
          <Item where={"/fire"} title={"파이어볼트"} backdrop_path={"https://imgur.com/lNjjhy6.png"}></Item>
          <Item where={"/odd"} title={"이상한 피카츄"} backdrop_path={"https://imgur.com/hsnt3Jt.png"}></Item>
          <Item where={"/rect"} title={"네모네모 피카츄"} backdrop_path={"https://imgur.com/IWmdZqO.png"}></Item>
          ...
          <Item where={"/notebook"} title={"박제현의 노트북"} backdrop_path={"https://imgur.com/fvX0Rrc.png"}></Item>
          <Item where={"/dongsang"} title={"김도영의 고등해커 동상"} backdrop_path={"https://imgur.com/aHxTLjR.png"}></Item>
